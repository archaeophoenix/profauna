    ...
    <div class="card">
        ...
        <table class="datatable table table-striped primary" cellspacing="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn badge badge-info badge-icon" onclick='window.location="<?php echo url.'projek/detail/'.$value['id']; ?>"' title="Detail"><i class="fa fa-newspaper-o"></i></button>
                <?php if (date('Y-m-d') < $value['tanggal_awal']){ ?>
                  <button type="button" title="Edit" class="btn badge badge-icon badge-primary" onclick='window.location="<?php echo url.'projek/form/'.$value['id']; ?>"'><i class="fa fa-edit"></i></button>
                  <button type="button" title="Peserta" class="btn badge badge-success badge-icon" onclick='window.location="<?php echo url.'projek/peserta/'.$value['id']; ?>"'><i class="fa fa-users"></i></button>
                <?php } ?>
              </td>
            </tr>
            <?php } ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-2 col-xs-offset-9 text-right">
          ...
          <button type="button" class="btn btn-xs btn-primary" onclick="tableToExcel('excel', 'Daftar Projek');" title="Excel"><i class="fa fa-file-excel-o"></i></button>
        </div>
