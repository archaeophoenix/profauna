<div class="row">
  <div class="col-xs-12">
    <div class="card">
      <div class="card-header">Input Projek</div>
      <div class="card-body">
        <div class="row">
          <div class="col-xs-12">
            <form class="form form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo url.'projek/submit/'.$data['id']; ?>">
              <div class="section">
                <div class="section-title">Projek</div>
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-xs-3 control-label">Projek</label>
                    <div class="col-xs-9">
                      <input type="hidden" name="id_user" value="<?php echo $_SESSION['id']; ?>">
                      <input style="border-radius: 50px;" type="text" class="form-control" name="nama" value="<?php echo $data['nama']; ?>" placeholder="Nama Projek">
                    </div>
                  </div>
                  <div class="form-group">
