          ...
          <div class="card-header">
            <ul class="nav nav-tabs">
              <li role="tab1" class="active">
                <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;Event</a>
              </li>
              <li role="tab2" class="">
            ...
            <div role="tabpanel" class="tab-pane active" id="tab1">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    <label class="col-xs-3 control-label text-capitalize">type Event</label>
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-xs-9 control-label text-capitalize">
                      <a onclick='window.location="<?php echo url.'event/detail/'.$data['id_projek']; ?>"' style="cursor: pointer;"><span class="badge badge-info badge-icon"><i class="fa fa-newspaper-o" aria-hidden="true"></i><span><?php echo $data['projek']; ?></span></span></a>
                    &nbsp;</label>
                  </div>
                </div>
              </div>
                ...
                <div id="print">
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="col-xs-6">
                        <div class="form-group">
                          <label class="col-xs-4 control-label text-capitalize">Event</label>
                        ...
                        <div class="form-group">
                          <label class="col-xs-4 control-label text-capitalize">type event</label>
                      ...
                      <div class="col-xs-6">
                        ...
                        <div class="form-group">
                          <label class="col-xs-4 control-label text-capitalize">Projek terkait</label>
                          <label class="col-xs-8 control-label text-capitalize"><?php echo $data['projek']; ?>&nbsp;</label>
                        </div>
                        <div class="form-group">
